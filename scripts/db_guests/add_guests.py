...
guests = [
    "Andrea Nocentini", "Annachiara Frontani", "Tommaso Borri", "Cristian Sorrentino", 
    "Dennis Cetoloni", "Lorenzo Scartoni", "Emanuele Vallone", "Raffaele Margarit", 
    "Giulia Umbertini", "Melissa Gironi", "Giulia Manetti", "Samuele del Pizzo", 
    "Marita Gunteichvili", "Ector Albarafo", "Giovvanni Manella", "Ciro Fortunato", 
    "Linda Boschi", "Matteo Bernardini", "Matteo Balsamo"
]
